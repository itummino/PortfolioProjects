...
SELECT TOP 1 MovieTitle, Rating from NetflixOriginals
ORDER BY Rating DESC

-- want to find 5 lowest movie ratings
SELECT TOP 5 MovieTitle, Genre, Rating from NetflixOriginals
ORDER BY Rating 


--------------- analyzing movie ratings data into performance categories -------------------
...
SELECT COUNT(MovieTitle) FROM NetflixOriginals WHERE RatingCategory = 'Great' AND ReleaseYear = 2019
-- answer was 2

-- find the total amount of movies considered great in 2015
SELECT COUNT(MovieTitle) FROM NetflixOriginals WHERE RatingCategory = 'Great' AND ReleaseYear = 2015
...
SELECT ReleaseYear, COUNT(*) FROM NetflixOriginals as RatingCount WHERE RatingCategory = 'Great' 
GROUP BY ReleaseYear
ORDER BY 2 DESC
-- 2020 was the year with the highest rated Netflix original movies (7)

-- How many movies total have recevied 'bad' reviews?
SELECT COUNT(*) FROM NetflixOriginals WHERE RatingCategory = 'Bad'
